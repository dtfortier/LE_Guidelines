        ...
        <div class="container">
            <div class="row">
                ...
                <div class="content-wrap">
                    ...
                    <p>
                        <ul>
                            <li>blue #477db3 - This will be used as the primary color as well as the heading text color</li>
                            <li>orange  #f79720 - This will be used as the primary call to action color</li>
                            <li>lighter gray #f9f9f9 - This will be used as ......</li>
                            <li>light gray #edeced - This will be used as the containers background color</li>
                            <li>medium grey #cbcccd - This will be used as quick stat icons and left nav child link color</li>
                            <li>dark gray #91a0ad - This will be used as the top nav link color and data available section</li>
                            <li>darker grey #4c5965 - This will be used for report titles and other priority labels as well as left nav color</li>
